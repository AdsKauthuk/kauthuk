        ...
        <div className="flex items-center gap-1 mb-3 justify-center">
          {[...Array(5)].map((_, i) => (
            <Star
              key={i}
              className={`w-4 h-4 ${
                i < rating ? "text-[#F0B775] fill-[#F0B775]" : "text-gray-200"
              }`}
            />
          ))}
        </div>
      ...
      <div className="max-w-6xl mx-auto relative">
        <div className="text-center mb-12">
          ...
          <p className="font-poppins text-gray-600 max-w-2xl mx-auto text-sm md:text-base">
            Discover authentic stories from our customers who have experienced
            the artistry and craftsmanship of our handcrafted treasures
          </p>
        </div>

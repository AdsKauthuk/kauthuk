          ...
          <div className="p-8">
            ...
            <div className="text-center mb-8">
              ...
              <div className="bg-[#f9f7f4] rounded-lg p-6 my-6 text-left">
                <h2 className="text-xl font-semibold text-[#6B2F1A] mb-4">Order Details</h2>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
                <Link href="/my-account">
                  <Button variant="outline" className="w-full sm:w-auto border-[#6B2F1A] text-[#6B2F1A] hover:bg-[#FFF5F1]">
                    View My Orders
                  </Button>
                </Link>
            ...
            <div className="mt-12 border-t border-gray-200 pt-8">
              <h2 className="text-xl font-semibold text-center mb-6">You Might Also Like</h2>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                {[1, 2, 3].map((item) => (
                  <Link href="/products" key={item} className="group">
                    ...
                    <div className="mt-2">
                      <h3 className="text-sm font-medium group-hover:text-[#6B2F1A] transition-colors">Recommended Product</h3>
